  ...
  const initializerCallData = Object.values({
    ...
    maxTimestamp:
      typeof window !== "undefined"
        ? new Date(
            (document.getElementById("date") as HTMLInputElement)?.value || 0
          ).getTime()
        : 0,
    ...
    calls: [
      {
        ...
        calldata: deployerCallData
          .concat(proxyCallData)
          .concat(initializerCallData),
      },
    ],
  });
        ...
        <div className={styles.line}>
          ...
          <div className={styles.inputContainer}>
            <input
              ...
              type="date"
              defaultValue={
                new Date(Date.now() + 1000 * 3600 * 24 * 30 * 6)
                  .toISOString()
                  .split("T")[0]
              }
            />
